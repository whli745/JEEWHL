...
public class ModelEditorJsonRestResource implements ModelDataJsonConstants {
    ...
    public void saveModel(@PathVariable String modelId, String name, String description
            , String json_xml, String svg_xml) throws Exception{
        try {
    ...
    public String getStencilset() throws Exception{
        String stencliset = "stencilset.json";
        Locale locale = Locale.getDefault();
        if (locale != null){
            String launguage = locale.toString();
            if ("zh_CN".equals(launguage)){
                stencliset = "stencilset_zh_CN.json";
            }
        }

        InputStream stencilsetStream = this.getClass().getClassLoader().getResourceAsStream(stencliset);
        try {
